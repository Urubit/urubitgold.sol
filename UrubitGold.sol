...
contract UrubitGold is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 34000  * 10**6;                                                 // totalSupply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;                                                               // total of fee

    string private _name = "Urubit Gold";                                                     // token name
    string private _symbol = "URUBG";                                                         // token symbol
    ...
    // set of fees
    uint256 public _taxFee = 2;  // Burn fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2; // Auto liquidity fee
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyTaxFee = 2; // Used for holder rewards and makreting wallet
    uint256 public _buyLiquidityFee = 2;
    
    uint256 public _sellTaxFee = 2; // Used for holder rewards and makreting wallet
